...
1. Download the latest firmware for your device from the [Releases](https://github.com/texsean/Raamses/releases) page
...
See the [Wiki](https://github.com/texsean/Raamses/wiki) for detailed installation instructions.
...
See [LICENSE](LICENSE) — All Rights Reserved. Commercial use requires permission.
